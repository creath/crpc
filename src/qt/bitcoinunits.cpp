...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("CereiPayCoins"));
    case mBTC: return QString(QObject::tr("Milli-CereiPayCoins (1 / 1,000)"));
    default: return QString("???");
    }
}
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case BTC: return 15; // 210,000,000 (# digits, without commas)
    case mBTC: return 18; // 210,000,000,000
    default: return 0;
    }
}
